...
#+begin_src emacs-lisp
  ...
  (setq dired-dwim-target t) ;; copy from one dired buffer to another
...
** Beginning of line
Move to beginning of line or beginning of code
#+begin_src emacs-lisp
...
** Cmake
pip install cmake-language-server to install cmake lsp 
#+begin_src emacs-lisp
