...
#+PROPERTY: header-args:emacs-lisp :tangle /home/alvarocea/.emacs.d/init.el :mkdirp yes
...
(defvar *emacs_config* "/mnt/work/develop/lessOns/con_emacs/Emacs_linux.org")
(defvar *bash* "~/.bashrc")
